...
let YpIconCall1: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
YpIconCall1.defaultProps = {
  size: 18,
};

YpIconCall1 = React.memo ? React.memo(YpIconCall1) : YpIconCall1;

export default YpIconCall1;
