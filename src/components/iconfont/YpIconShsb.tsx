...
let YpIconShsb: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
YpIconShsb.defaultProps = {
  size: 18,
};

YpIconShsb = React.memo ? React.memo(YpIconShsb) : YpIconShsb;

export default YpIconShsb;
